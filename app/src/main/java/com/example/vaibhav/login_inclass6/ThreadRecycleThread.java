...
public class ThreadRecycleThread extends RecyclerView.Adapter<ThreadRecycleThread.ViewHolder> {
    public ArrayList<Thread> threadList = null;
    LoginDetails loginDetails = null;

    public  ThreadRecycleThread(){}
    public ThreadRecycleThread(ArrayList<Thread> list,LoginDetails loginDetails)
    {
    ...
    public void removeItem(Thread position)
    {
